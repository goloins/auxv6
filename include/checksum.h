...
void aux_crc32_init(void);
uint32_t aux_crc32_update_byte(uint32_t crc, uint8_t b);
uint32_t aux_crc32_update(uint32_t crc, const uint8_t *buf, size_t len);
uint32_t aux_crc32_finish(uint32_t crc);
