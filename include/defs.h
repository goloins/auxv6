...
int             audio_set_nonblock(struct file *f, int enabled);
int             audio_get_nonblock(struct file *f);
...
void            lapiceoi(void);
void            lapicinit(void);
int             lapic_timer_calibrate_hpet(uint freq_hz);
uint            lapic_timer_initial_count(void);
int             lapic_timer_is_calibrated(void);
...
int             argstr(int, char**);
int             argstr_copyin(int, char*, uint);
int             fetchint(uint, int*);
int             fetchstr(uint, char**);
int             fetchstr_copyin(uint, char*, uint);
void            syscall(void);
